...
#ifndef AMCLRTC_TEST__H
#define AMCLRTC_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  AMCLRTCTest(RTC::Manager* manager);
 ...
 protected:
  ...
  /*!
   */
  RTC::InPort<RTC::TimedPoint2D> m_estimatedPoseIn;
  ...
  /*!
   */
  RTC::OutPort<RTC::TimedPose2D> m_robotPoseOut;
...
extern "C"
{
  DLL_EXPORT void AMCLRTCTestInit(RTC::Manager* manager);
};

#endif // AMCLRTC_TEST_H
